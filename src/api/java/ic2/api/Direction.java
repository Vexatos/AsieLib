...
public enum Direction {
	...
	public static Direction fromForgeDirection(ForgeDirection dir){
		...
		if(dir.DOWN == dir){	return Direction.YN;}
		else if(dir.UP == dir){	return Direction.YP;}
		else if(dir.NORTH == dir){	return Direction.ZN;}
		else if(dir.SOUTH == dir){	return Direction.ZP;}
		else if(dir.WEST == dir){	return Direction.XN;}
		else {	return Direction.XP;}
	}
