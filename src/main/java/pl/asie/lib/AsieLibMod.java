...
@Mod(modid = Mods.AsieLib, name = Mods.AsieLib_NAME, version = "0.3.8", useMetadata = true, dependencies = "after:CoFHAPI|block@[1.7.10R1.0.0,);after:CoFHAPI|energy@[1.7.10R1.0.0,);after:CoFHAPI|tileentity@[1.7.10R1.0.0,);after:CoFHAPI|item@[1.7.10R1.0.0,)")
